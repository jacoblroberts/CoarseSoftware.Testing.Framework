        ...
        public IEnumerator<IntegrationTestCase> GetEnumerator()
        {
            yield return new IntegrationTestCase("Loading the Dashboard")
            {
                ...
                Service = new IntegrationTestCase.Microservice
                {
                    ...
                    Request = new CoarseSoftware.BusinessSystem.iFX.Request<DashboardManagerFacet.OnStepCompleteBase>
                    {
            ...
            yield return new IntegrationTestCase("Administration Types Tested")
            {
                ...
                Service = new IntegrationTestCase.Microservice
                {
                    ...
                    {
                        Data = new CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete
                        {
                            ...
                            SubClasses = new List<CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete.SubClass>
                            {
                                new CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete.SubClass
                                {
                                    SomeEnum = CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete.SomeEnum.None,
                                    SomeEnumNull = CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete.SomeEnum.None
                                },
                                new CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete.SubClass
                                {
                                    SomeEnum = CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete.SomeEnum.Value,
                                    SomeEnumNull = CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete.SomeEnum.None
                                }
                            },
                            SubClassWithValue = new CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete.SubClass
                            {
                                SomeEnum = CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete.SomeEnum.Value,
                                SomeEnumNull = CoarseSoftware.BusinessSystem.Component.Manager.Administration.Interface.UseCases.SomeContext.DerivedOnStepComplete.SomeEnum.None
                            }
